...
int ferret_filter_mac(struct Krackips *krackips, const unsigned char *mac_addr);

void parse_ethernet_frame(struct Krackips *krackips, struct NetFrame *frame, const unsigned char *px, unsigned length);
void parse_wifi_frame(struct Krackips *krackips, struct NetFrame *frame, const unsigned char *px, unsigned length);
...
unsigned krackips_get_interface_status(struct Krackips *krackips, const char *devicename, unsigned *r_channel);
void krackips_set_interface_status(struct Krackips *krackips, const char *devicename, unsigned is_running, unsigned channel);
void krackips_launch_thread(struct Krackips *krackips, const char *adapter_name);
